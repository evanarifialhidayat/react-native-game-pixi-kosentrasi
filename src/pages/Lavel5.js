...
export default class Lavel5 extends Component<{}>{
	   ...
	   constructor(props){
		    ...
		    this.state = {
		      ...
		      urlgame:'http://45.77.45.3:8080/konsentrasi/lavel5.html?widthx='+Dimensions.get('window').width+'&heightx='+(Dimensions.get('window').height - 100),
		    }
		  }
...
componentDidMount() {
    Expo.ScreenOrientation.allow(Expo.ScreenOrientation.Orientation.PORTRAIT);
       ...
       // AdMobInterstitial.addEventListener('interstitialDidLoad', () => this.ActivityIndicatorLoadingView() ); 
        AdMobInterstitial.addEventListener('interstitialDidFailToLoad',() => Actions.Lavel6() ); 
       // AdMobInterstitial.addEventListener('interstitialDidOpen', () => console.log('interstitialDidOpen') );
        AdMobInterstitial.addEventListener('interstitialDidClose',() =>  Actions.Lavel6() );
        AdMobInterstitial.addEventListener('interstitialWillLeaveApplication',() => Actions.Lavel6() );
