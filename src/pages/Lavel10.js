...
export default class Lavel10 extends Component<{}>{
	   ...
	   constructor(props){
		    ...
		    this.state = {
		      ...
		      urlgame:'http://45.77.45.3:8080/konsentrasi/lavel10.html?widthx='+Dimensions.get('window').width+'&heightx='+(Dimensions.get('window').height - 100),
		    }
		  }
...
componentDidMount() {
    Expo.ScreenOrientation.allow(Expo.ScreenOrientation.Orientation.PORTRAIT);
        ...
        AdMobInterstitial.setAdUnitID('ca-app-pub-5882049283613214/7366844542'); 
       // AdMobInterstitial.addEventListener('interstitialDidLoad', () => this.ActivityIndicatorLoadingView() ); 
        AdMobInterstitial.addEventListener('interstitialDidFailToLoad',() => Actions.Lavel1() ); 
       // AdMobInterstitial.addEventListener('interstitialDidOpen', () => console.log('interstitialDidOpen') );
        AdMobInterstitial.addEventListener('interstitialDidClose',() =>  Actions.Lavel1() );
        AdMobInterstitial.addEventListener('interstitialWillLeaveApplication',() => Actions.Lavel1() );
