...
export default class Lavel2 extends Component<{}>{
	   ...
	   constructor(props){
		    ...
		    this.state = {
		      ...
		      urlgame:'http://45.77.45.3:8080/konsentrasi/lavel2.html?widthx='+Dimensions.get('window').width+'&heightx='+(Dimensions.get('window').height - 100),
		    }
		  }
...
componentDidMount() {
    Expo.ScreenOrientation.allow(Expo.ScreenOrientation.Orientation.PORTRAIT);
        ...
        AdMobInterstitial.setAdUnitID('ca-app-pub-5882049283613214/7116574865'); 
       // AdMobInterstitial.addEventListener('interstitialDidLoad', () => this.ActivityIndicatorLoadingView() ); 
        AdMobInterstitial.addEventListener('interstitialDidFailToLoad',() => Actions.Lavel3() ); 
       // AdMobInterstitial.addEventListener('interstitialDidOpen', () => console.log('interstitialDidOpen') );
        AdMobInterstitial.addEventListener('interstitialDidClose',() =>  Actions.Lavel3() );
        AdMobInterstitial.addEventListener('interstitialWillLeaveApplication',() => Actions.Lavel3() );
