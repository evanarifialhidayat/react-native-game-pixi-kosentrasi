...
export default class Lavel3 extends Component<{}>{
	   ...
	   constructor(props){
		    ...
		    this.state = {
		      ...
		      urlgame:'http://45.77.45.3:8080/konsentrasi/lavel3.html?widthx='+Dimensions.get('window').width+'&heightx='+(Dimensions.get('window').height - 100),
		    }
		  }
...
componentDidMount() {
    Expo.ScreenOrientation.allow(Expo.ScreenOrientation.Orientation.PORTRAIT);
       ...
       // AdMobInterstitial.addEventListener('interstitialDidLoad', () => this.ActivityIndicatorLoadingView() ); 
        AdMobInterstitial.addEventListener('interstitialDidFailToLoad',() => Actions.Lavel4() ); 
       // AdMobInterstitial.addEventListener('interstitialDidOpen', () => console.log('interstitialDidOpen') );
        AdMobInterstitial.addEventListener('interstitialDidClose',() =>  Actions.Lavel4() );
        AdMobInterstitial.addEventListener('interstitialWillLeaveApplication',() => Actions.Lavel4() );
